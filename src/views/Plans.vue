                                              ...
                                              <base-table
                                                ...
                                                >
                                                  <template slot="columns">
                                                    ...
                                                    <th><span v-if="lang=='english'">Category</span><span v-if="lang=='arabic'">فئة</span></th>
                                                  ...
                                                  >
                                                    ...
                                                    <th class="align-middle">
                                                      <span class="mb-0 font-weight-400">{{ row.business_id.business_category.business_category_name }}</span>
                                                    </th>
...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      axios
      .post(process.env.VUE_APP_API_ENDPOINT+'read_projectplan',{"details":{"created_by":localStorage.getItem('_id'),"status" :"approved"}},this.auth)
      .then(response => {
