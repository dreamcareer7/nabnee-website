<template>
    <section class="section section-shaped section-lg my-0">
        <div class="shape shape-style-1 bg-gradient-default bg-gradient-success">
            <span></span>
            <span></span>
            <span></span>
            <span></span>
                                ...
                                <form @submit.prevent>
                                   <div class="">
                                    <div class="row">
                                      ...
                                      <div class="col-lg-12">
                                          <base-input alternative="" label="Business GPS Address" placeholder="Business GPS Address" input-classes="form-control-alternative" v-model="gpslink" />
                                      </div>
                                      <div class="col-lg-12">
                                      ...
                                      <div class="col-lg-12 d-flex mt-4 mb-4">
                                        ...
                                        <!-- <div class="select-day">
                                          <a class="cursor-pointer days active" id="Monday" @click="selectday('Monday')">Mon</a>
                                        </div>

                                        <div class="select-day">
                                          <a class="cursor-pointer days" id="Tuesday" @click="selectday('Tuesday')">Tue</a>
                                        </div>

                                        <div class="select-day">
                                          <a class="cursor-pointer days" id="Wednesday" @click="selectday('Wednesday')">Wed</a>
                                        </div>

                                        <div class="select-day">
                                          <a class="cursor-pointer days" id="Thursday" @click="selectday('Thursday')">Thu</a>
                                        </div>

                                        <div class="select-day">
                                          <a class="cursor-pointer days" id="Friday" @click="selectday('Friday')">Fri</a>
                                        </div>

                                        <div class="select-day">
                                          <a class="cursor-pointer days" id="Saturday" @click="selectday('Saturday')">Sat</a>
                                        </div>

                                        <div class="select-day">
                                          <a class="cursor-pointer days" id="Sunday" @click="selectday('Sunday')">Sun</a>
                                        </div> -->
                                      </div>
                                      ...
                                      <div class="col-md-12 mb-1" v-for="(day,index) in leisure_hours" :key="index">
                                        <span class="mb-2 d-block text-sm">{{day.day}}</span>
                                        <div class="row">
                                          <div class="col-lg-4 col-5 mb-3">
...
<script>
  ...
  export default {
    ...
    hadleimage: function(event) {
            ...
            axios
            .post(process.env.VUE_APP_API_ENDPOINT+'upload_file',fd,{ headers: {'Content-Type': 'multipart/form-data'},onUploadProgress: function( progressEvent ) { this.uploadPercentage = parseInt( Math.round( ( progressEvent.loaded * 100 ) / progressEvent.total ) ); console.log(this.uploadPercentage)}.bind(this)})
            .then(response => {
              //console.log(response);
                  this.model.logo='http://api.nabnee.com/'+response.data.path;
    ...
    hadleicon: function(event) {
            ...
            .then(response => {
              //console.log(response);
                  this.model.cover_image='http://api.nabnee.com/'+response.data.path;
