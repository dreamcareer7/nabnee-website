              ...
              <div class="col-lg-9 col-md-8 h-100">
                <div class="card shadow overflow-hidden rounded h-100">
                  <div class="position-absolute inventory-title">
                    <p v-if="lang=='english'" class="mb-0 font-weight-bold">
                      <router-link to="/products" class="mr-3 btn btn-sm btn-success">
                        <i class="fa fa-chevron-left mr-2"></i>Back
                      </router-link>
                      <span><h1 class="d-inline font-weight-bold">{{design.item_name}}</h1></span>
                    </p>
                    <p v-if="lang=='arabic'" class="mb-0 font-weight-bold">
                      <router-link to="/products" class="mr-3 btn btn-sm btn-success">
                ...
                <div class="card shadow rounded h-100 design-content">
                    <div class="cover-box">
                      ...
                      <div class="card-profile">
                        <div class="card-profile-image">
                            <router-link :to="'/business/'+design.created_by.user_id" class="">
                              ...
                              <div class="mb-2">
                                <div>
                                  <div class="h6 description mt-4">
                                    <i class="fa fa-cubes text-success mr-1"></i><span class="text-success font-weight-bold mr-2">Category:</span> <h4 class="description d-inline" v-if="design.item_category">{{design.item_category.inventory_category_name}} </h4>
                                  </div>
                                </div>
                                <div>
                                  <div class="h6 description mt-2">
                                    <i class="ni ni-archive-2 text-success mr-2"></i><span class="text-success font-weight-bold mr-2">Sub-category:</span> <h4 class="description d-inline" v-if="design.item_subcategory">{{design.item_subcategory.inventory_subcategory_name}}</h4>
                                  </div>
                                </div>
                                <div>
                                  <div class="h6 description mt-2">
                                    <i class="fa fa-tag text-success mr-2"></i><span class="text-success font-weight-bold mr-2">Brand:</span> <span v-if="design.item_brand">{{design.item_brand}}</span>
                                  </div>
                                </div>
                                <div>
                                  <div class="h6 description mt-2">
                                    <i class="fa fa-money text-success mr-2"></i><span class="text-success font-weight-bold mr-2">Price:</span> <span v-if="design.item_cost">{{design.item_cost}}</span>
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="design-info pt-4 px-3" v-if="lang=='arabic'">
                              <h2 class="h6 text-center font-weight-bold" v-if="design.created_by">{{design.created_by.business_name_arabic}}<span v-if="!design.created_by.business_name_arabic">{{design.created_by.business_name_english}}</span></h2>
                              <h3 class="text-center description" v-if="design.created_by">{{design.created_by.business_description_arabic}}<span v-if="!design.created_by.business_description_arabic">{{design.created_by.business_description_english}}</span></h3>
                    ...
                    <div class="gallery container pb-3">
                        <div class="row pt-3">
                            <div class="col-md-4 cursor-pointer mb-2 sub-images" v-for="(images,index) in design.item_img" :key="index">
                                <img :src="images" class="hover-zoom img-fluid rounded" @click="showimage(images)">
                            </div>
                    ...
                    <div class="container border-top pt-3">
                      <div class="row">
                          ...
                          <div class="col-md-3 col-6 pl-md-1 pr-md-2 px-3" v-if="lang=='english'">
                            ...
                            <base-button block type="secondary" size="sm" class="success" v-if="itemexist(design._id)" icon="fa fa-bookmark" >Saved</base-button>
                          </div>
                          <div class="col-md-3 col-6 pl-md-1 pr-md-2 px-3" v-if="lang=='arabic'">
                            <base-button block type="secondary" size="sm" class="" v-if="!itemexist(design._id)" icon="fa fa-bookmark" @click="opencollectionwindow(design)">حفظ</base-button>
                            <base-button block type="secondary" size="sm" class="success" v-if="itemexist(design._id)" icon="fa fa-bookmark" >تم الحفظ</base-button>
                          </div>
                          <div class="col-md-6 pl-md-1 pl-3 mt-2 mt-md-0">
                              <base-button outline type="success" block size="sm" @click="opencomment(design)" icon="fa fa-plus"><span v-if="lang=='english'">Comment</span><span v-if="lang=='arabic'">تعليق</span></base-button>
                          </div>
                      </div>
                    </div>
